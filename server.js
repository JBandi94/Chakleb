        ...
        try {
            ...
            connection.on(WebcastEvent.CHAT, (data) => {
                ...
                io.emit('tiktok-chat', {
                    ...
                    comment,
                    followRole,
                    profilePictureUrl: user.profilePictureUrl || user.avatarLarger || user.avatarMedium || user.avatarThumb || user.avatar_url || data?.profilePictureUrl || data?.avatarLarger || data?.avatarMedium || data?.avatarThumb || data?.avatar_url || ''
                });
            });
