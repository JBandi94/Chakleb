...
const { WebcastPushConnection } = require('@toa-everitt/tiktok-live-connector');
...
io.on('connection', (socket) => {
    ...
    socket.on('connect-tiktok', async (data) => {
        ...
        try {
            ...
            // الاستماع لخروج أو قطع اتصال المتابعين (تأخير الإقصاء لحماية أصحاب الإنترنيت الضعيف)
