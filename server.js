        ...
        try {
            ...
            connection.on(WebcastEvent.CHAT, (data) => {
                ...
                const uniqueId = String(
                    user.uniqueId ?? data?.uniqueId ?? data?.user?.unique_id ?? ''
                ).trim();

                const nickname = String(
                    (user.nickname ?? data?.nickname ?? uniqueId ?? 'مستخدم')
                ).trim();
                ...
                console.log(`[TikTok CHAT] @${uniqueId} (${nickname}): ${comment}`);
            ...
            connection.on(WebcastEvent.MEMBER, (data) => {
                ...
                io.emit('tiktok-member-event', {
                    ...
                    nickname: user.nickname || user.uniqueId || 'مستخدم',
                    action: 'join'
                });
            });
