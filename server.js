    ...
    socket.on('connect-tiktok', async (data = {}) => {
        ...
        try {
            ...
            connection.on(WebcastEvent.CHAT, (data) => {
                ...
                // v2.x exposes the avatar primarily as data.profilePictureUrl.
                // Some payloads also expose a list under userDetails.profilePictureUrls.
                ...
                console.log(`[TikTok AVATAR] @${uniqueId}: ${profilePictureUrl ? 'OK' : 'MISSING'}`);
            ...
            connection.on(WebcastEvent.MEMBER, (data) => {
                ...
                const memberProfilePictureUrl = String(
                    data?.profilePictureUrl ||
                    user?.profilePictureUrl ||
                    user?.userDetails?.profilePictureUrls?.[0] ||
                    data?.userDetails?.profilePictureUrls?.[0] ||
